            ...
            <table>
                ...
                {data.map((country) => (
                    <tr class="even:bg-amber-9 odd:bg-blue-100" key={country.code}>
                        <td>
                            <Link href={`/countries/${encodeURIComponent(country.code)}`} class="px-2 py-0 text-blue-100 no-underline bg-blue-500 rounded hover:bg-blue-600 hover:underline hover:text-blue-200">
